...
import 'package:leave_a_review/screens/arc.dart';
import 'package:leave_a_review/utils/colors.dart';
import 'package:leave_a_review/utils/sizing.dart';
import 'slider.dart';
                      ...
                      TweenAnimationBuilder(
                        ...
                        builder: (context, doubleVal, child) {
                          return Transform.translate(
                            offset: Offset(
                                0, doubleVal * -AppSizing.height(context) / 2),
                            child: Column(
                              children: [
                                headerSection(),
                                eyesSection(),
